...
namespace NetInfo.Audit.Tests.McAfee {
  ...
  [TestFixture]
  public class IP007_Tests {

    [Test]
    public void IP007_should_return_true_when_manager_ip_address_matches_correct_noc_address() {
...
Logging TCP Port : 8503"
      ...
      ISTIGItem item = new IP007(device, new List<IPAddress> { IPAddress.Parse("1.1.1.1") });
    ...
    [Test]
    public void IP007_should_return_false_when_manager_ip_address_does_not_match_correct_noc_address() {
      var blob = new AssetBlob {
        Body = @"[Sensor Network Config]
IP Address : 10.24.192.110
Netmask : 255.255.255.224
