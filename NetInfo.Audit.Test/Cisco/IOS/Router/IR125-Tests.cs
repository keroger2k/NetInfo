...
namespace NetInfo.Audit.Tests.Cisco.IOS.Router {
  ...
  [TestFixture]
  public class IR125_Tests {

    [Test]
    public void IR125_should_return_true_when_there_are_no_interfaces_with_test() {
      var blob = new AssetBlob {
        Body = @""
      };

      INMCIIOSDevice device = new NMCIIOSDevice(blob);
      ISTIGItem item = new IR125(device);
    ...
    [Test]
    public void IR125_should_return_true_when_all_test_interfaces_are_connected() {
      var blob = new AssetBlob {
        Body = @"AKOZ-U00-IR-01#!
...
AKOZ-U00-IR-01#!"
    ...
    [Test]
    public void IR125_should_return_false_when_a_test_interface_is_not_connected() {
      var blob = new AssetBlob {
        Body = @"AKOZ-U00-IR-01#!
AKOZ-U00-IR-01#show interface status
...
AKOZ-U00-IR-01#!"
    ...
    [Test]
    public void IR125_should_return_true_when_a_test_interface_is_disabled() {
      var blob = new AssetBlob {
        Body = @"AKOZ-U00-IR-01#!
AKOZ-U00-IR-01#show interface status
