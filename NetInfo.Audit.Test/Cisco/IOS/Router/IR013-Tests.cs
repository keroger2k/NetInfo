...
"
      ...
      ISTIGItem item = new IR013(device);
    ...
    [Test]
    public void IR013_should_return_false_when_interface_is_assigned_to_vlan_2_or_3_and_still_has_any_trunking_commands_applied() {
      AssetBlob blob = new AssetBlob {
        Body = @"
!
