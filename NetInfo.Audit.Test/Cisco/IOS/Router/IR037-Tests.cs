...
namespace NetInfo.Audit.Tests.Cisco.IOS.Router {
  ...
  [TestFixture]
  public class IR037_Tests {

    [Test]
    public void IR037_should_return_true_when_all_external_interfaces_have_no_ip_proxy_arp_configured() {
...
QUAN-UB1-EO-01#!"
    ...
    [Test]
    public void IR037_should_return_false_when_not_all_external_interfaces_have_no_ip_proxy_arp_configured() {
      var blob = new AssetBlob {
        Body = @"!
!
interface Multilink1
