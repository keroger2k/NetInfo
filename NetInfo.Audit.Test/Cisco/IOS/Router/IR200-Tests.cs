...
namespace NetInfo.Audit.Tests.Cisco.IOS.Router {
  ...
  [TestFixture]
  public class IR200_Tests {

    [Test]
    public void IR200_should_return_true_when_user_name_is_correct() {
...
"
      ...
      ISTIGItem item = new IR200(device);
    ...
    [Test]
    public void IR200_should_return_false_when_user_name_is_incorrect() {
      AssetBlob blob = new AssetBlob {
        Body = @"
ABCD-U00-IR-01#show snmp user
...
"
    ...
    [Test]
    public void IR200_true_when_server_uses_inform_instead_of_informs_and_user_name_is_correct() {
      AssetBlob blob = new AssetBlob {
        Body = @"
...
"
    ...
    [Test]
    public void IR200_false_when_server_uses_inform_instead_of_informs_and_user_name_is_incorrect() {
      AssetBlob blob = new AssetBlob {
        Body = @"
snmp-server group nmcigroup v3 priv write NMS notify *tv.FFFFFFFF.FFFFFFFF.FFFFFFFF.0000000F access 69
snmp-server host 10.0.16.136 inform version 3 priv nmsops
...
"
    ...
    [Test]
    public void IR200_should_return_true_when_server_uses_informs_and_user_name_is_correct() {
      AssetBlob blob = new AssetBlob {
        Body = @"
...
"
    ...
    [Test]
    public void IR200_should_return_false_when_server_uses_informs_and_user_name_is_incorrect() {
      AssetBlob blob = new AssetBlob {
        Body = @"
snmp-server group nmcigroup v3 priv write NMS notify
...
"
    ...
    [Test]
    public void IR200_should_return_false_when_snmp_is_not_enabled() {
      AssetBlob blob = new AssetBlob {
        Body = @"
