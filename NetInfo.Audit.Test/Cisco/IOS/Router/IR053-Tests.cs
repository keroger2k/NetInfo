...
namespace NetInfo.Audit.Tests.Cisco.IOS.Switch {
  ...
  [TestFixture]
  public class IR053_Tests {

    [Test]
    public void IR053_should_return_true_when_all_users_ports_are_not_assigned_to_vlan_1() {
...
ABCD-U00-IR-01#!"
    ...
    [Test]
    public void IR053_should_return_false_when_any_user_port_is_assigned_to_vlan_1() {
      var blob = new AssetBlob {
...
PNDL-U08-DP-06#!"
    ...
    [Test]
    public void IR053_should_disregard_monitoring_ports_and_their_assignment_to_vlan_1() {
      var blob = new AssetBlob {
...
ALBY-U00-IS-03#!"
    ...
    [Test]
    public void IR053_should_disregard_disabled_ports_and_their_assignment_to_vlan_1() {
      var blob = new AssetBlob {
        Body = @"ALBY-U00-IS-03#show interface status
...
ALBY-U00-IS-03#!"
    ...
    [Test]
    public void IR053_should_fail_devices_with_ports_that_are_inactive_and_assigned_to_vlan_1() {
      var blob = new AssetBlob {
