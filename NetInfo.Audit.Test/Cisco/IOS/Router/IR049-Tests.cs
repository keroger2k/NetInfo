...
namespace NetInfo.Audit.Tests.Cisco.IOS.Router {
  ...
  public class IR049_Tests {
    ...
    [Test]
    public void IR049_should_return_true_when_only_informational_is_found_for_unmanaged_devices() {
...
DANI-U00-OR-01#!"
      ...
      ISTIGItem item = new IR049(device);
    ...
    [Test]
    public void IR049_should_return_true_when_only_logging_trap_command_is_not_found_in_configuration_and_logging_trap_is_not_disabled_for_unmanaged_devices() {
      var blob = new AssetBlob {
        Body = @"!
!
!
...
DANI-U00-OR-01#!"
    ...
    [Test]
    public void IR049_should_return_true_when_logging_notifications_is_found_for_managed_devices() {
      var blob = new AssetBlob {
        Body = @"!
logging trap notifications
!
...
DANI-U00-OR-01#!"
    ...
    [Test]
    public void IR049_should_return_true_when_logging_informational_is_enabled_for_ODMN_devices() {
      var blob = new AssetBlob {
        Body = @"!
!
logging trap informational
...
DANI-U00-OR-01#!"
    ...
    [Test]
    public void IR049_should_return_false_when_logging_informational_is_not_enabled_for_ODMN_devices() {
      var blob = new AssetBlob {
        Body = @"!
!
logging trap notifications
