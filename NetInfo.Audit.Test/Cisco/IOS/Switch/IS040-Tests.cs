...
namespace NetInfo.Audit.Tests.Cisco.IOS.Router {
  ...
  [TestFixture]
  public class IS040_Tests {

    [Test]
    public void IS040_should_return_true_when_all_external_interfaces_have_no_ip_redirects_configured() {
...
QUAN-UB1-EO-01#!"
      ...
      ISTIGItem item = new IS040(device);
    ...
    [Test]
    public void IS040_should_return_false_when_not_all_external_interfaces_have_no_ip_redirects_configured() {
      var blob = new AssetBlob {
        Body = @"!
!
interface Multilink1
