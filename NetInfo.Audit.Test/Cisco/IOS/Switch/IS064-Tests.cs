...
namespace NetInfo.Audit.Tests.Cisco.IOS.Switch {
  ...
  [TestFixture]
  public class IS064_Tests {

    [Test]
    public void IS064_should_return_true_when_a_device_has_snmp_v3_configured_and_no_community_strings() {
...
snmp-server group nmcigroup v3 priv write NMS notify *tv.FFFFFFFF.FFFFFFFF.FFFFFFFF.FFFFFFFF.FFFFFFFF0F access 69"
      ...
      ISTIGItem item = new IS064(device);
    ...
    [Test]
    public void IS064_should_return_false_when_a_device_has_snmp_v3_configured_and_community_strings() {
      var blob = new AssetBlob {
        Body = @"snmp-server engineID remote 10.0.16.134 515C41E69D2F0022F21D94FA
snmp-server group nmcigroup v3 priv write NMS notify *tv.FFFFFFFF.FFFFFFFF.FFFFFFFF.FFFFFFFF.FFFFFFFF0F access 69
