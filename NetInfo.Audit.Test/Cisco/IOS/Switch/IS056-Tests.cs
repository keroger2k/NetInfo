...
access-list 99 deny   any log".ToConfig()
    ...
    [Test]
    public void IS056_should_return_true_when_acl_99_matches_the_approved_acl() {
...
!"
      ...
      ISTIGItem item = new IS056(device, approvedAcl);
    ...
    [Test]
    public void IS056_should_return_false_when_acl_99_does_not_matches_the_approved_acl() {
      var blob = new AssetBlob {
        Body = @"!
access-list 98 remark Norfolk NOC
access-list 98 permit 10.32.9.224 0.0.0.31 log
...
!"
    ...
    [Test]
    public void IS056_should_return_true_when_the_last_line_has_spaces_after_the_deny_statement() {
      var blob = new AssetBlob {
        Body = @"!
access-list 99 remark Norfolk NOC
access-list 99 permit 10.16.27.32 0.0.0.31 log
