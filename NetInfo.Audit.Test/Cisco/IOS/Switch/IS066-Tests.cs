...
namespace NetInfo.Audit.Tests.Cisco.IOS.Router {
  ...
  [TestFixture]
  public class IS066_Tests {

    [Test]
    public void IS066_should_return_true_when_there_is_a_log_statement_at_the_end_of_each_deny() {
...
!"
      ...
      ISTIGItem item = new IS066(device);
    ...
    [Test]
    public void IS066_should_return_true_when_there_is_not_a_log_statement_at_the_end_of_each_deny() {
      var blob = new AssetBlob {
        Body = @"!
access-list 69 remark Norfolk NOC
access-list 69 permit 10.16.27.32 0.0.0.31
