...
namespace NetInfo.Audit.Tests.Cisco.IOS.Switch {
  ...
  [TestFixture]
  public class IS042_Tests {

    [Test]
    public void IS042_should_return_true_when_snmp_server_group_has_allowed_access_groups_applied_67_68_69_() {
...
!"
      ...
      ISTIGItem item = new IS042(device);
    ...
    [Test]
    public void IS042_should_return_false_when_snmp_server_group_has_incorrect_allowed_access_groups_applied_not_67_68_69_() {
      var blob = new AssetBlob {
        Body = @"!
...
!"
    ...
    [Test]
    public void IS042_should_return_true_when_snmp_server_group_does_not_contain_access_group_info_instead_checks_show_snmp_user_and_access_list_is_allowed() {
      var blob = new AssetBlob {
        Body = @"!
...
"
    ...
    [Test]
    public void IS042_should_return_false_when_snmp_server_group_does_not_contain_access_group_info_instead_checks_show_snmp_user_and_access_list_is_not_allowed() {
      var blob = new AssetBlob {
        Body = @"!
snmp-server group nmcigroup v3 auth write NMS notify
...
"
    ...
    [Test]
    public void IS042_should_return_false_when_snmp_is_not_enabled() {
      var blob = new AssetBlob {
        Body = @"
