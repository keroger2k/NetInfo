...
namespace NetInfo.Audit.Tests.Cisco.IOS.Switch {
  ...
  [TestFixture]
  public class IS147_Tests {

    [Test]
    public void IS147_should_return_true_when_group_name_is_correct() {
...
"
      ...
      ISTIGItem item = new IS147(device);
    ...
    [Test]
    public void IS147_should_return_false_when_group_name_is_incorrect() {
      AssetBlob blob = new AssetBlob {
        Body = @"
ABCD-U00-IR-01#show snmp user
...
"
    ...
    [Test]
    public void IS147_true_when_server_uses_inform_instead_of_informs_and_group_name_is_correct() {
      AssetBlob blob = new AssetBlob {
        Body = @"
...
"
    ...
    [Test]
    public void IS147_false_when_server_uses_inform_instead_of_informs_and_group_name_is_incorrect() {
      AssetBlob blob = new AssetBlob {
        Body = @"
...
"
    ...
    [Test]
    public void IS147_should_return_true_when_server_uses_informs_and_group_name_is_correct() {
      AssetBlob blob = new AssetBlob {
        Body = @"
...
"
    ...
    [Test]
    public void IS147_should_return_false_when_server_uses_informs_and_group_name_is_incorrect() {
      AssetBlob blob = new AssetBlob {
        Body = @"
...
"
    ...
    [Test]
    public void IS147_should_return_false_when_snmp_is_not_enabled() {
      AssetBlob blob = new AssetBlob {
        Body = @"
