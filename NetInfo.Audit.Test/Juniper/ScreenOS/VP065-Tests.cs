...
namespace NetInfo.Audit.Tests.Juniper.ScreenOS {
  ...
  public class VP065_Tests {
    ...
    [Test]
    public void VP065_should_return_true_when_all_the_correct_snmp_hosts_are_configured() {
...
"
      ...
      ISTIGItem item = new VP065(device, addresses);
    ...
    [Test]
    public void VP065_should_return_false_when_hosts_are_not_in_correct_sequence() {
      var blob = new AssetBlob {
        Body = @"
set snmp host ""jPC$!wEWxs57"" 10.0.16.138 255.255.255.255 src-interface ethernet0/0 trap v1
set snmp host ""jPC$!wEWxs57"" 10.16.27.62 255.255.255.255 src-interface ethernet0/0 trap v1
...
"
    ...
    [Test]
    public void VP065_should_return_false_when_device_is_missing_host() {
      var blob = new AssetBlob {
        Body = @"
set snmp host ""jPC$!wEWxs57"" 10.16.27.62 255.255.255.255 src-interface ethernet0/0 trap v1
set snmp host ""jPC$!wEWxs57"" 10.16.27.33 255.255.255.255 src-interface ethernet0/0 trap v1
...
"
    ...
    [Test]
    public void VP065_should_return_false_when_device_has_an_extra_host() {
      var blob = new AssetBlob {
        Body = @"
...
"
    ...
    [Test]
    public void VP065_should_return_false_when_no_hosts_are_found() {
      var blob = new AssetBlob {
        Body = @""
      };
