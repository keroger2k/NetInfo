...
namespace NetInfo.Audit.Tests.Riverbed.RIOS {
  ...
  public class RB010_Tests {
    ...
    [Test]
    public void RB010_should_return_false_when_a_banner_is_not_found() {
      blob = new AssetBlob {
...
alias exec utb_WAN OC3-POS_DISA_v7_3"
      ...
      ISTIGItem item = new RB010(device);
    ...
    [Test]
    public void RB010_should_return_true_for_a_device_that_matches_government_banner() {
      blob = new AssetBlob {
        Body = @"##
   banner login ""
...
"
    ...
    [Test]
    public void RB010_should_return_false_for_a_device_that_doesnt_match_the_government_banner() {
      blob = new AssetBlob {
        Body = @"##
   banner login ""
You are accessing a U.S. Government (USG) Information System (IS) that is
