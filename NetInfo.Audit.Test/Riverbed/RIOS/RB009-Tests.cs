...
namespace NetInfo.Audit.Tests.Brocade.BOS.Switch {
  ...
  [TestFixture]
  public class RB009_Tests {

    [Test]
    public void RB009_should_return_true_when_the_community_string_matches_the_approved_string_in_NMS_scripts() {
...
"
      ...
      ISTIGItem item = new RB009(device, "eY129sYgPP0B");
    ...
    [Test]
    public void RB009_should_return_false_when_the_community_string_does_not_match_the_approved_string_in_NMS_scripts() {
      var blob = new AssetBlob {
        Body = @"
    rbm role CMC_Group_PRLH primitive /role_primitive/cmc/config/group/PRLH
