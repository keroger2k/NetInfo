...
namespace NetInfo.Audit.Juniper.ScreenOS {
  ...
  /// <summary>
  /// Validate the correct snmp hosts are configured per the hardening script (USN)
  /// </summary>
  public class VP065 : ISTIGItem {

    public IDevice Device { get; private set; }

    private readonly IEnumerable<IPAddress> _addresses;

    public VP065(INMCIScreenOSDevice device, IEnumerable<IPAddress> addresses) {
      this.Device = device;
