...
namespace NetInfo.Audit.Cisco.IOS.Switch {
  ...
  /// <summary>
  /// Validate the "snmp-server group" command for unclassified devices
  /// includes "access 67" or "access 68" or "access 69"
  /// </summary>
  public class IS042 : ISTIGItem {

    public IDevice Device { get; private set; }

    private int[] allowedAccessLists = new int[] { 67, 68, 69 };

    public IS042(INMCIIOSDevice device) {
      this.Device = device;
    }
