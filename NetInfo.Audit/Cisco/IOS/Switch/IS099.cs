...
namespace NetInfo.Audit.Cisco.IOS.Switch {
  ...
  /// </summary>
  public class IS099 : ISTIGItem {

    public IDevice Device { get; private set; }

    public IS099(INMCIIOSDevice device) {
      this.Device = device;
    }

    public bool Compliant() {
      var device = (INMCIIOSDevice)Device;
      return !string.IsNullOrEmpty(device.ShowVtpStatus.DomainName) && !string.IsNullOrEmpty(device.ShowVtpPassword.Password);
    }
  }
}