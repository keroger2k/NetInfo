...
namespace NetInfo.Audit.Cisco.IOS.Router {
  ...
  /// <summary>
  /// Ensure this command exists and uses the correct source IP address: "ntp source vlanXX"  (see comment)
  ///
  ...
  public class IR167 : ISTIGItem {
    ...
    public bool Compliant() {
      ...
      return ApprovedSources.Contains(device.NetworkTimeProtocol.SourceVlan);
    }
  }
}