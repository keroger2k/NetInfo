...
namespace NetInfo.Audit.Cisco.IOS.Router {
  ...
  /// <summary>
  /// Ensure this command exists and uses the correct source
  /// IP address: "ip tacacs source-interface" (see comment)
  ///
  ...
  ///   - DSL Device Type Names: DA,DH,DM,DP,WR
  /// </summary>
  public class IR008 : ISTIGItem {

    public IDevice Device { get; private set; }
    private Regex sourceInterfaceRegex;

    public IR008(INMCIIOSDevice device) {
      this.Device = device;
    }
    ...
    public bool Compliant() {
      ...
      return this.sourceInterfaceRegex != null && this.sourceInterfaceRegex.Match(device.IPSettings.TacacsSourceInterface).Success;
    }
